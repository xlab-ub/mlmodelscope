...
export default function withPagination(WrappedComponent, dataPropertyName, searchTerm) {
    ...
    render() {
      ...
      return (
        <div className="paginated-content">
          <PageNavigationSummary data={this.state.pageData} pageCount={this.state.pageCount} selectedPage={this.state.selectedPage} totalCount={this.props.data.length} searchTerm={searchTerm}/>
