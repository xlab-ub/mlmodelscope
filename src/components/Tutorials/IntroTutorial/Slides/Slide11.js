    ...
    <div className={getElement("text-area")}>
      ...
      <div className={getElement("sub-title-wrapper")}>
        ...
        <p className={getElement("sub-title")}>
          Models can perform a variety of tasks, like recognizing objects in an image or identifying a speaker in an
          audio
          file. Earlier, we looked at an image classification task. Here are some model tasks you’ll find on this
          website.
