...
export const DefaultSemanticSegmentationModel = {
  ...
  "framework": {"id": 4, "name": "TensorFlow", "version": "1.14.0", "architectures": [{"name": "amd64"}]},
  "input": {"description": "", "type": ""},
  "license": "Apache License, Version 2.0",
  "name": "DeepLabv3_MobileNet_v2_PASCAL_VOC_Train_Val",
  "output": {"description": "the output semantic segment", "type": "image_semantic_segmentation"},
  "url": {
    "github": "https://github.com/rai-project/tensorflow/blob/master/builtin_models/DeepLabv3_MobileNet_v2_PASCAL_VOC_Train_Val.yml",
...
export const DefaultObjectDetectionModel = {
  ...
  "attributes": {"Top1": "", "Top5": "", "kind": "CNN", "manifest_author": "Jingning Tang", "training_dataset": "COCO"},
  ...
  "output": {"description": "the output bounding box", "type": "image_object_detection"},
  "url": {
    "github": "http://download.tensorflow.org/models/object_detection/faster_rcnn_inception_resnet_v2_atrous_lowproposals_coco_2018_01_28.tar.gz",
...
export const DefaultImageEnhancementModel = {
  ...
  "short_description": "SRGAN is a generative adversarial network for single image super-resolution.",
  "model": {
  ...
  "framework": {"id": 2, "name": "Onnxruntime", "version": "1.6.0", "architectures": [{"name": "amd64"}]},
  "input": {"description": "", "type": ""},
  "license": "unrestricted",
  "name": "SRGAN",
  "output": {"description": "the output image", "type": "image_enhancement"},
  "url": {
    "github": "https://github.com/eriklindernoren/PyTorch-GAN/blob/master/implementations/srgan/srgan.py",
